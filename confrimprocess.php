...
if($getstring2 == "approve"){
	...
	$updatestatusapprove = "UPDATE produk set status = 'approve' WHERE idproduk = '$getidproduk2'";
	...
	$updatestatusreject = "UPDATE produk set status = 'reject' WHERE idproduk = '$getidproduk2'";
